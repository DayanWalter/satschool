    ...
    <div className='flex h-80 flex-col justify-between'>
      ...
      >
        <div className='relative size-full'>
          <Image src={product.image} alt='product image' sizes='100%' fill className='object-cover' />
        </div>
        {isProductInCart && (
          <div className='absolute bottom-0 w-full bg-gray-400 px-4 py-2 text-center text-gray-600'>Added To Cart</div>
        )}
      </div>
